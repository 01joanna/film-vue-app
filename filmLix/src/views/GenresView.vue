<template>
  <div>
    ...
    <h3 class="text-[40px] gap-5 mb-10 mt-5 justify-center  text-customWhite">Genres</h3>

    <!-- Comedy Section -->
    <div class="flex justify-around  mb-5">
      <h4 class="text-[28px] text-customWhite">Comedy</h4>
      <h4 class="text-[28px] text-customWhite cursor-pointer" @click="loadMore('comedy')">More</h4>
    </div>
    <section
    ...
    <div class="flex justify-around  mb-5">
      ...
      <h4 class="text-[28px] text-customWhite cursor-pointer" @click="loadMore('action')">More</h4>
    </div>
    <section
      class="secondHomepage flex flex-col gap-5 mb-20 justify-center items-center"
    ...
    <div class="flex justify-around  mb-5">
      ...
      <h4 class="text-[28px] text-customWhite cursor-pointer" @click="loadMore('fantasy')">More</h4>
    </div>
    <section
      class="secondHomepage flex flex-col gap-5 mb-20 justify-center items-center"
  ...
  methods: {
    async loadMovies() {
      try {
        ...
        this.comedyMovies = data.filter((movie) => movie.Genre.includes("Comedy"));
        this.actionMovies = data.filter((movie) => movie.Genre.includes("Action"));
        this.fantasyMovies = data.filter((movie) => movie.Genre.includes("Fantasy"));
