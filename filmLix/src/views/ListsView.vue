<template>
    <div>
        ...
        <section class="flex flex-col gap-5  mb-20 justify-center px-28 items-center ">
            <h3 class="text-[40px] text-customWhite w-full pl-6 text-left">Lists</h3>
            
            <!-- Comfort Movies LIST -->
            <section class="mb-6">
                <div class="flex justify-between items-top mb-5">
